...
object GamePlan {
  val Group = ArrayBuffer(
    GamePlanEntry("gameplan.group.0", 0, 0, 0,  Array()),
    GamePlanEntry("gameplan.group.1", 1, 0, 0, Array()),
    GamePlanEntry("gameplan.group.2", 2, 0, 0, Array()),
    GamePlanEntry("gameplan.group.3", 3, 3, 3, Array(
      Array((1,3)),
      Array((2,3)),
      Array((1,2))
    )),
    GamePlanEntry("gameplan.group.4", 4, 3, 6, Array(
      Array((1,4), (2,3)),
      Array((1,3), (2,4)),
      Array((1,2), (3,4))
    ))Array
    GamePlanEntry("gameplan.group.5", 5, 5, 10, Array(
      Array((1,5), (2,3)),
      Array((4,5), (1,3)),
      Array((2,4), (3,5)),
      Array((1,4), (2,5)),
    ...
    GamePlanEntry("gameplan.group.6", 6, 5, 15, Array(
      Array((1,6), (2,3), (4,5)),
      Array((1,3), (4,6), (2,5)),
      Array((1,4), (3,5), (2,6)),
      Array((1,5), (2,4), (3,6)),
    ...
    GamePlanEntry("gameplan.group.7", 7, 7, 21, Array(
      Array((1,7), (2,3), (4,5)),
      Array((1,6), (3,7), (2,4)),
      Array((1,5), (3,6), (2,7)),
      Array((1,4), (2,5), (6,7)),
    ...
    GamePlanEntry("gameplan.group.8", 8, 7, 28, Array(
    ...
    GamePlanEntry("gameplan.group.9", 9, 9, 36, Array(
    ...
    GamePlanEntry("gameplan.group.10", 10, 9, 45, Array(

...
// Date format (UTC) yyyy-MM-dd HH:mm:ss	2012-01-31 23:59:59

object JsonCSVTest {
  val content = """{
    "tityp" :  "backup",
    "date"   : "2019-04-30 11:59:59",
    "issuer" : "version 100"
  }""" 
}


object TourneyCttTestData1 {
  val content = """<?xml version="1.0" encoding="utf-8"?>
<!DOCTYPE tournament SYSTEM "http://www.datenautomaten.nu/dtd/nuLiga/TournamentPortal.dtd">
<tournament end-date="2019-11-30" start-date="2019-11-30" name="101. Internationale Freisinger Meisterschaften Freisinger" tournament-id="i36eIvYBUqxYW1OUCKu2pT5v50i4mxM0">
	
		<competition start-date="2019-11-30 12:00" ttr-from="1650" ttr-to="3000" ttr-remarks="S-Klasse" age-group="Herren" type="Einzel">
			<players>
					...
					<player type="single" id="PLAYER41">
						<person licence-nr="202004168" club-federation-nickname="ByTTV" club-name="TV Wald Endor" sex="1" ttr-match-count="82" lastname="Haar" ttr="1904" internal-nr="NU1281105" club-nr="202774" firstname="Ross" birthyear="1999"/>
					</player>
		...
		<competition start-date="2020-04-02 08:00" ttr-from="0" ttr-to="1200" ttr-remarks="D-Klasse" age-group="Damen" type="Einzel">
			<players>
		...
		<competition start-date="2020-04-02 08:00" ttr-from="1501" ttr-to="1650" ttr-remarks="B-Klasse" age-group="Damen" type="Einzel">
			<players>
					<player type="single" id="PLAYER81">
					...
					<player type="single" id="PLAYER82">
	    ...
	    <competition start-date="2020-04-01 14:00" ttr-from="1650" ttr-to="3000" ttr-remarks="S-Klasse" age-group="Herren" type="Doppel">		
			<players>
					<player type="double" id="PLAYER92">
						<person licence-nr="111009155" club-federation-nickname="ByTTV" club-name="TV Traktor Leipzig" sex="1" ttr-match-count="351" lastname="Kahn" ttr="1792" internal-nr="NU1000999" club-nr="111009" firstname="Ada" birthyear="1965"/>
						<person licence-nr="105018106" club-federation-nickname="ByTTV" club-name="TTC Torpedo Moskau" sex="1" ttr-match-count="118" lastname="Tion" ttr="1846" internal-nr="NU210649" club-nr="105018" firstname="Addi" birthyear="1947"/>
					</player>
...
object TourneyJsonTestData1 {
  def content(toId: Long) = s"""{
    "basis": "Meisterschaft 2019-12-01^TTC FS88^ttcfs88^20191201^20191202^IDENTTourney20191201^1^false^lastname·firstname·phone·email·_^description·country·zip·city·street·_^${toId}^_",
    "ccphs": [],
    "comps": [
      "1^101^Herren S-Klasse Einzel^Einzel^2019-12-01 12:00^-1^Herren·S-Klasse·_^_",
      "2^102^Damen D-Klasse Einzel^Einzel^2019-12-01 08:00^-1^Damen·D-Klasse·_^_",
      "3^103^Damen B-Klasse Einzel^Einzel^2019-12-01 08:00^0^Damen·B-Klasse·_^_",
      "4^104^Herren S-Klasse Doppel^Doppel^2019-12-01 14:00^-1^Herren·S-Klasse·_^_"
    ],
    
    "clubs": [
      "1^11^TV Traktor Leipzig^_^_",
      "2^12^MBB SG Motzen^_^_",
      "3^33^TTC Torpedo Moskau^_^_",
      "4^14^TTC Phatt Island^_^_"
    ],
    
    "players": [
       "1^1001^1^TV Traktor Leipzig^Ada^Kahn^1965^^1^_^_",
       "2^1002^3^TTC Torpedo Moskau^Max^Strammer^1978^^1^_^_",
       "3^1003^2^MBB SG Motzen^Lene^Arm^1976^^1^_^_",
       "4^1004^4^TTC Phatt Island^Lotte^Macchiato^1962^^1^_^_",
       "5^1005^2^MBB SG Motzen^Adi^Lette^1960^^1^_^_",
       "6^1006^1^TV Traktor Leipzig^Ali^Bert^1965^^1^_^_"
    ],
    ...
    "do2co": [
       "1^6^4^Doppel200^^IDENT200^200^0^_^_",
       "2^5^4^Doppel201^^IDENT201^201^0^_^_",
       "2^3^4^Doppel202^^IDENT202^202^1^_^_"
    ]
  }""" 
}

  ...
  with TourneySvc with LicenseSvc with AuthenticateSvc with WrapperSvc
{
  ...
  def testMatchEncode(tnp: TNP) = {
    ...
    aBufMEntry += MEntryKo(1, CompTyp.SINGLE, 3, CompPhaseTyp.KO, 31,"00021","00022", 7, 2, "game3#1","game4#2", "1·3·3", "Halbfinale", "20220207170409", "20220207171019", 2, (3,2), 3, "8·-4·4·-11·0")
    aBufMEntry += MEntryGr(1, CompTyp.DOUBLE, 1, CompPhaseTyp.GR, 77,"00019","00020", 3, 4, (1,5), "", "", "1·3·3", "2.Runde", "20220207170409", "20220207171019", 3, (0,3), 3, "11·-4·-0")
